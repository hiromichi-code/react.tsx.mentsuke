...
import '../components/ThirtyTwoRight.css';

const ThirtyTwoRight = () => {
  return (
    <div>
      <div className="l-secondary">
        <div className="left-out">
          ...
          <div className="out-seven"></div>
          <div className="out-eight"></div>
          <div className="out-nine"></div>
          <div className="out-ten"></div>
          <div className="out-eleven"></div>
          <div className="out-twelve"></div>
        ...
        <div className="eight">
          <div className="top-out width"></div>
          <div className="out-one"></div>
          <div className="out-two direction-eleven rotate-direction"></div>
          <div className="out-three"></div>
          <div className="out-four"></div>
          <div className="out-five direction-fourteen rotate-direction"></div>
          <div className="out-six"></div>
          <div className="out-seven"></div>
          <div className="out-eight"></div>
          <div className="out-nine"></div>
        ...
        <div className="eleven">
          <div className="top-out width"></div>
          <div className="out-one"></div>
          <div className="out-two direction-six rotate-direction"></div>
          <div className="out-three"></div>
          <div className="out-four"></div>
          <div className="out-five direction-three rotate-direction"></div>
          <div className="out-six"></div>
          <div className="out-seven"></div>
          <div className="out-eight"></div>
          <div className="out-nine"></div>
